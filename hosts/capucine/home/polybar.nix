{
  ...
  services.polybar = {
    ...
    settings = let
      ...
      wlanModules = builtins.foldl' (acc: interface: acc // mkWlanModule interface) {} config.my.wirelessInterfaces;
    in
      wlanModules
      // {
        "bar/default" = {
          ...
          modules-left = "i3";
          modules-center = "";
          modules-right = "nixosfs eth cpu memory wireguard ${lib.strings.intersperse " " config.my.wirelessInterfaces} date pulseaudio temperature dunst battery tray";
