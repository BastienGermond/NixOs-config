...
in {
  ...
  services.nginx = {
    ...
    in {
      ...
      "docs.germond.org" = withDefaultConfiguration "docs.germond.org" {
        locations."/" = {
          recommendedProxySettings = true;
          proxyPass = "http://${anemone.ips.vpn.A}";
        };
      ...
      "vouch.germond.org" = withDefaultConfiguration "vouch.germond.org" {
        locations."/" = {
          recommendedProxySettings = true;
      ...
      "prometheus.germond.org" = withDefaultConfiguration "prometheus.germond.org" {
        locations."/validate" = {
          priority = 0;
          recommendedProxySettings = true;
