{withDefaultConfiguration, anemone, ...}:
withDefaultConfiguration "suwayomi.germond.org" {
  locations."/validate" = {
    priority = 0;
  ...
  locations."/" = {
    recommendedProxySettings = true;
    proxyPass = "http://${anemone.ips.vpn.A}:${builtins.toString anemone.ports.suwayomi}";
    extraConfig = ''
